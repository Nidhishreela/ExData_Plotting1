...
par(mfrow =c(2,2))
with(new,{
  plot(new$dateTime,new$Global_active_power,type = 'l',xlab='',ylab = 'Global Active Power')
  ...
  legend(x = 'topright',lty = 'solid',col = c('black','orange','blue'),legend = c('Sub_metering_1','Sub_metering_2','Sub_metering_3'),cex = 0.7)
  plot(new$dateTime,new$Global_reactive_power,xlab='DateTime',ylab = 'Global Reactive Power',type='l')})
dev.off()
